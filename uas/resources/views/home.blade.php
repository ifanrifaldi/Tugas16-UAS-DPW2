...
<html class="no-js" lang="zxx">
   <head>
      ...
      <title>FannShoes</title>
      <meta name="description" content="">
      <meta name="viewport" content="width=device-width, initial-scale=1">
      <!-- Place favicon.ico in the root directory -->
      <link rel="shortcut icon" type="image/x-icon" href="{{url('public')}}/assets2/img/favicon.png">
      <!-- CSS here -->
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/preloader.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/bootstrap.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/meanmenu.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/animate.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/owl-carousel.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/swiper-bundle.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/backtotop.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/magnific-popup.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/nice-select.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/flaticon/flaticon.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/font-awesome-pro.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/default.css">
      <link rel="stylesheet" href="{{url('public')}}/assets2/css/style.css">
   </head>
   <body>
      <!--[if lte IE 9]>
    ...
    <!-- footer-end -->
      ...
      <!-- JS here -->
      <script src="{{url('public')}}/assets2/js/vendor/jquery.js"></script>    
      <script src="{{url('public')}}/assets2/js/vendor/waypoints.js"></script>
      <script src="{{url('public')}}/assets2/js/bootstrap-bundle.js"></script>
      <script src="{{url('public')}}/assets2/js/meanmenu.js"></script>
      <script src="{{url('public')}}/assets2/js/swiper-bundle.js"></script>
      <script src="{{url('public')}}/assets2/js/tweenmax.js"></script>
      <script src="{{url('public')}}/assets2/js/owl-carousel.js"></script>
      <script src="{{url('public')}}/assets2/js/magnific-popup.js"></script>
      <script src="{{url('public')}}/assets2/js/parallax.js"></script>
      <script src="{{url('public')}}/assets2/js/backtotop.js"></script>
      <script src="{{url('public')}}/assets2/js/nice-select.js"></script>
      <script src="{{url('public')}}/assets2/js/countdown.min.js"></script>
      <script src="{{url('public')}}/assets2/js/counterup.js"></script>
      <script src="{{url('public')}}/assets2/js/wow.js"></script>
      <script src="{{url('public')}}/assets2/js/isotope-pkgd.js"></script>
      <script src="{{url('public')}}/assets2/js/imagesloaded-pkgd.js"></script>
      <script src="{{url('public')}}/assets2/js/ajax-form.js"></script>
